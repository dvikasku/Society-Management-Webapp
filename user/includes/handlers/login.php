...
//echo $flatno;
    ...
    $query = "SELECT * FROM allotments WHERE allotments.FlatNumber='{$flatno}' AND ( allotments.OwnerContactNumber = '{$contactno}' OR allotments.OwnerAlternateContactNumber ='{$contactno}' or allotments.RenteeContactNumber = '{$contactno}' OR allotments.RenteeAlternateContactNumber ='{$contactno}') and allotments.BlockNumber='{$blockno}'";
